...
const { addToCart, getCart, clearCart, removeFromCart,updateCartItemQuantity,countCartItem } = require('../controllers/cartController');
...
router.get("/cart/count",isAuthenticated,countCartItem); //
